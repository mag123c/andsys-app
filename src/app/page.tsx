...
const faqs = [
  {
    ...
    answer:
      "게스트는 현재 브라우저에만 저장됩니다. 회원가입하시면 서버에 안전하게 백업되어 다른 기기에서도 이어쓸 수 있어요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "게스트는 '인터넷 사용 기록 삭제'에서 '쿠키 및 사이트 데이터'를 삭제하면 소설도 함께 삭제됩니다. 회원이라면 다시 로그인하면 복구됩니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "회원가입하시면 서버에 자동 백업되어 어떤 기기에서든 로그인만 하면 이어쓸 수 있습니다. 게스트는 현재 브라우저에서만 접근 가능합니다.",
  },
];
